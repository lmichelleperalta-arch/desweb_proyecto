...
urlpatterns = [
    ...
    path("prediosupdate_catastrodj/<int:id>/",views.PrediosUpdate.as_view(),name="prediosupdate_catastrodj"),
    path("callesinsert_catastrodj/", views.CallesInsert.as_view(),name="callesinsert_catastrodj"),
    path("callesdelete_catastrodj/<int:id>/",views.CallesDelete.as_view(),name="callesdelete_catastrodj"),
    ...
    path("callesupdate_catastrodj/<int:id>/",views.CallesUpdate.as_view(),name="callesupdate_catastrodj_catastrodj"),
